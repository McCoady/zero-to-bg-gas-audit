...
contract ZeroToBuidlGuidlNFTGassed is ERC721 {
    /*´:°•.°+.*•´.*:˚.°*.˚•´.°:°•.°•.*•´.*:˚.°*.˚•´.°:°•.°+.*•´.*:*/
    /*                      STATE VARIABLES                       */
    /*.•°:°.´+˚.*°.˚:*.´•*.+°.•°:´*.´•*.•°.•°:°.´:•˚°.*°.˚:*.´+°.•*/
    ...
    function mintNft() public payable {
        ...
        s_tokenIdToTokenMinter[thisId] = msg.sender;
        s_tokenIdToBlockNumber[thisId] = block.number;
        s_tokenIdToDonation[thisId] = msg.value;
